...
// Note: Very very useful example [We are doing CRUD operations with JdbcTemplate API]
...
// See... we are not deling with Connection object because we JdbcTemplate class do it internally.
...
public class MainApp {
   public static void main(String[] args) {
      ...
      Student student = studentJDBCTemplate.getStudent(4); // pass the respetive ID Here
